/**
 * @file bm_config_cortexa_conc_hybrid.h
 * @brief hybrid 层并发测试（bm_stream owner 边界契约）QEMU Cortex-A15 SMP 配置
 * @author zeh (china_qzh@163.com)
 * @version 1.0
 * @date 2026-06-26
 */
#ifndef BM_CONFIG_CORTEXA_CONC_HYBRID_H
#define BM_CONFIG_CORTEXA_CONC_HYBRID_H
...
#endif /* BM_CONFIG_CORTEXA_CONC_HYBRID_H */
