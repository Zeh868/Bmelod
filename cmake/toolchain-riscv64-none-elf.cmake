...
if(DEFINED ZEPHYR_SDK_INSTALL_DIR AND EXISTS
   "${ZEPHYR_SDK_INSTALL_DIR}/riscv64-zephyr-elf/bin/riscv64-zephyr-elf-gcc${_BM_HOST_EXE}")
    ...
    if(NOT _BM_RISCV64_GCC)
        message(FATAL_ERROR
            "RISC-V 64 toolchain not found (riscv64-zephyr-elf-gcc, riscv64-unknown-elf-gcc, or riscv64-none-elf-gcc)")
    endif()
    set(CMAKE_C_COMPILER ${_BM_RISCV64_GCC})
    set(CMAKE_ASM_COMPILER ${_BM_RISCV64_GCC})
    find_program(CMAKE_OBJCOPY
        NAMES riscv64-zephyr-elf-objcopy riscv64-unknown-elf-objcopy riscv64-none-elf-objcopy)
endif()
...
if(_BM_RISCV_GCC_MAJOR GREATER_EQUAL 12)
    set(_BM_RISCV_MARCH "rv64imac_zicsr_zifencei")
else()
    set(_BM_RISCV_MARCH "rv64imac")
endif()

set(CMAKE_C_FLAGS "-march=${_BM_RISCV_MARCH} -mabi=lp64 -mcmodel=medany -Os -ffunction-sections -fdata-sections -Wall -Wextra -std=c99")
set(CMAKE_ASM_FLAGS "-march=${_BM_RISCV_MARCH} -mabi=lp64 -mcmodel=medany")
