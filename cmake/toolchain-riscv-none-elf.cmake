...
set(_BM_RISCV32_TOOLCHAIN_FOUND OFF)
if(DEFINED _BM_ZEPHYR_SDK_ROOT)
    # Zephyr SDK 旧布局：$ZEPHYR_SDK_INSTALL_DIR/<triplet>/bin/
    # （rv32 复用 riscv64 工具链的 multilib：-march=rv32imac -mabi=ilp32）
    ...
    if(EXISTS "${_BM_ZEPHYR_TOOLCHAIN_PREFIX}/riscv64-zephyr-elf-gcc${_BM_HOST_EXE}")
        ...
        set(_BM_RISCV32_TOOLCHAIN_FOUND ON)
    endif()
endif()

if(NOT _BM_RISCV32_TOOLCHAIN_FOUND)
