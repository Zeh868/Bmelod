...
static const bm_exec_t g_audio_exec = {
    .id = 1u, .owner_cpu = 0u, .name = "audio_agc",
    .state = &g_audio_state, .config = NULL, .resources = NULL,
    .slots = g_audio_slots, .slot_count = 2u,
    .claims = NULL, .claim_count = 0u, .ops = &g_audio_ops
};
