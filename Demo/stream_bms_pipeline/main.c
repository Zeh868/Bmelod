...
static const bm_exec_t g_bms_exec = {
    .id = 1u, .owner_cpu = 0u, .name = "bms_pipeline",
    .state = &g_bms_state, .config = NULL, .resources = NULL,
    .slots = g_bms_slots, .slot_count = 2u,
    .claims = NULL, .claim_count = 0u, .ops = &g_bms_ops
};
