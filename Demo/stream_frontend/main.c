...
static const bm_exec_t g_stream_fe_exec_bound = {
    .id = 1u, .owner_cpu = 0u, .name = "stream_fe",
    .state = &g_stream_fe_state, .config = NULL, .resources = NULL,
    .slots = g_stream_fe_slots, .slot_count = 2u,
    .claims = NULL, .claim_count = 0u, .ops = &g_stream_fe_ops
};
